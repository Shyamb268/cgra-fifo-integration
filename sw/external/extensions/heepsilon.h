...
#define EXT_XBAR_NSLAVE  4  // Support for 4 CGRA instances

#define CGRA_START_ADDRESS (EXT_SLAVE_START_ADDRESS + 0x000000)
#define CGRA_SIZE 0x100000
#define CGRA_END_ADDRESS (CGRA_START_ADDRESS + (CGRA_SIZE * EXT_XBAR_NSLAVE))

#define CGRA_PERIPH_START_ADDRESS (EXT_PERIPHERAL_START_ADDRESS + 0x0000000)
#define CGRA_PERIPH_SIZE 0x0001000
#define CGRA_PERIPH_END_ADDRESS (CGRA_PERIPH_START_ADDRESS + (CGRA_PERIPH_SIZE * EXT_XBAR_NSLAVE))
